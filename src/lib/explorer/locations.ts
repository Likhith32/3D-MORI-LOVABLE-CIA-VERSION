...
export const LOCATIONS: Location[] = [
  ...
  },
  {
    ...
    description: "A sophisticated multipurpose facility hosting professional conferences, academic seminars, and leadership gatherings.",
  ...
  },
  {
    ...
    description: "A state-of-the-art cinematic auditorium designed for world-class performances, student assemblies, and cultural celebrations.",
  ...
  },
  {
    ...
    description: "A vibrant, light-filled creative space dedicated to the practice and performance of traditional and modern dance forms.",
